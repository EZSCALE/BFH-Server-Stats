...
if($SoldierName != null AND $SoldierName != 'Not Found')
{
	...
	<table class="prettytable">
	<tr>
	<td class="tablecontents" width="33%" style="text-align: center"><span class="information">Battlelog Stats: </span><a href="http://battlelog.battlefield.com/bfh/user/' . $SoldierName . '" target="_blank">www.Battlelog.Battlefield.com</a></td>
