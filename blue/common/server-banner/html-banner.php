...
if(!empty($sid))
{
	...
	echo '<center><a href="http://battlelog.battlefield.com/bfh/servers/pc/?filtered=1&amp;expand=0&amp;useAdvanced=1&amp;q=' . urlencode($server) . '" target="_blank"><b>' . $servername . '</b></a></center></div>';
	echo '
	<center>
